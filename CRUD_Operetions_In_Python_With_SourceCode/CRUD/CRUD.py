...
#creating table
        ...
        self.listTree = ttk.Treeview(self,height=14,columns=('First Name','Last Name','Gender','Address','Contact Number','Course', 'Active'))
        ...
        self.listTree.heading("Active", text='Active')
        self.listTree.column("Active", width=125, minwidth=125,anchor='center')
        ...
        def ser():
             try:
                ...
                cursor.execute("Select * from tbl_student where `Active`")
